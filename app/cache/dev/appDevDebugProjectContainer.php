...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'cart.cart_event_listener' => 'getCart_CartEventListenerService',
            'cart.cart_storage_manager' => 'getCart_CartStorageManagerService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/manu/projects/mamen-ecommerce/app/cache/dev/annotations', true);
    }
    ...
    /**
     * Gets the 'cart.cart_event_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Ecommerce\FrontendBundle\EventListener\CartEventSubscriber A Ecommerce\FrontendBundle\EventListener\CartEventSubscriber instance.
     */
    protected function getCart_CartEventListenerService()
    {
        return $this->services['cart.cart_event_listener'] = new \Ecommerce\FrontendBundle\EventListener\CartEventSubscriber($this->get('cart.cart_storage_manager'));
    }

    /**
     * Gets the 'cart.cart_storage_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Ecommerce\FrontendBundle\Storage\CartStorageManager A Ecommerce\FrontendBundle\Storage\CartStorageManager instance.
     */
    protected function getCart_CartStorageManagerService()
    {
        return $this->services['cart.cart_storage_manager'] = new \Ecommerce\FrontendBundle\Storage\CartStorageManager($this->get('session'));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_fd5165aa63ec52bf1ed93dace27bacc9b49777453d33cfc5d98e03e1aaf059fb');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_fd5165aa63ec52bf1ed93dace27bacc9b49777453d33cfc5d98e03e1aaf059fb');
        ...
        $g->setProxyDir('/home/manu/projects/mamen-ecommerce/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/manu/projects/mamen-ecommerce/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/manu/projects/mamen-ecommerce/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/manu/projects/mamen-ecommerce/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/manu/projects/mamen-ecommerce/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/home/manu/projects/mamen-ecommerce/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_UserService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/u/registro');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/u/email-disponible');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/u/recuperar-password');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/u/reenviar-correo-de-activacion');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/u/cambiar-password/*');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/u/*');
        ...
        $o->createUser(new \Symfony\Component\Security\Core\User\User('user', 'userpass', array(0 => 'ROLE_USER')));
        $o->createUser(new \Symfony\Component\Security\Core\User\User('admin', 'adminpass', array(0 => 'ROLE_ADMIN')));

        $p = new \Symfony\Component\Security\Http\HttpUtils($e, $e);

        $q = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), '7a6d5e633cddaead7bd4b4e075c2818c', 'user', array('lifetime' => 5184000, 'name' => 'REMEMBERME', 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $r = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $p, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($p, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'logout'));
        $r->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $r->addHandler($q);

        $s = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $p, 'user', new \Ecommerce\FrontendBundle\Component\Security\AuthenticationSuccessHandler($e), new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $p, array('login_path' => 'login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $d, NULL);
        $s->setRememberMeServices($q);

        return $this->services['security.firewall.map.context.user'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($n, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c, 1 => $o), 'user', $a, $d), 2 => $r, 3 => $s, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $q, $g, $a, $d), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5389cbf888347', $a), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $n, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $p, 'user', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $p, 'login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/manu/projects/mamen-ecommerce/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/manu/projects/mamen-ecommerce/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/manu/projects/mamen-ecommerce/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['session.storage.native'] = new \Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage(array('cookie_lifetime' => 604800), NULL, $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/manu/projects/mamen-ecommerce/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/manu/projects/mamen-ecommerce/app/cache/dev/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/manu/projects/mamen-ecommerce/app', 'UTF-8'));
     ...
     * This method always returns the same instance of the service.
     *
     * @return Ecommerce\FrontendBundle\Twig\Extension\StockBarExtension A Ecommerce\FrontendBundle\Twig\Extension\StockBarExtension instance.
     */
    protected function getTwig_Extension_StockbarService()
    {
        return $this->services['twig.extension.stockbar'] = new \Ecommerce\FrontendBundle\Twig\Extension\StockBarExtension();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/manu/projects/mamen-ecommerce/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/manu/projects/mamen-ecommerce/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        ...
        $instance->addPath('/home/manu/projects/mamen-ecommerce/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/manu/projects/mamen-ecommerce/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/manu/projects/mamen-ecommerce/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/manu/projects/mamen-ecommerce/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/home/manu/projects/mamen-ecommerce/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/manu/projects/mamen-ecommerce/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/manu/projects/mamen-ecommerce/app/cache/dev',
            'kernel.logs_dir' => '/home/manu/projects/mamen-ecommerce/app/logs',
            ...
            'debug.container.dump' => '/home/manu/projects/mamen-ecommerce/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '7a6d5e633cddaead7bd4b4e075c2818c',
            ...
            'session.save_path' => '/home/manu/projects/mamen-ecommerce/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/home/manu/projects/mamen-ecommerce/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/home/manu/projects/mamen-ecommerce/app/cache/dev/profiler',
            ...
            'router.resource' => '/home/manu/projects/mamen-ecommerce/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/manu/projects/mamen-ecommerce/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/manu/projects/mamen-ecommerce/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.read_from' => '/home/manu/projects/mamen-ecommerce/app/../web',
            'assetic.write_to' => '/home/manu/projects/mamen-ecommerce/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/home/manu/projects/mamen-ecommerce/app/cache/dev/doctrine/orm/Proxies',
