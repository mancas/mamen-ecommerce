 ...
 * @ORM\DiscriminatorMap({"item"="ImageItem"})
 */
abstract class Image
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Ecommerce\ImageBundle\Entity\ImageCopy", mappedBy="image", cascade={"persist", "merge", "remove"})
     */
    ...
    {
        $class = "Ecommerce\\ImageBundle\\Entity\\$type";
