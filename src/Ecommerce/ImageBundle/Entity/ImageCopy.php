 ...
 * @ORM\DiscriminatorMap({"imagethumbnail"="ImageThumbnail", "imageitembox"="ImageItemBox", "imageitemboxw"="ImageItemBoxW", "imageitemcarousel"="ImageItemCarousel", "imageitemcarouselthumbnail"="ImageItemCarouselThumbnail"})
 */
