...
namespace Ecommerce\LocationBundle\Command;

use Ecommerce\LocationBundle\Entity\City;
use Ecommerce\LocationBundle\Entity\Province;
...
class ImportLocationCommand extends ContainerAwareCommand
{
    ...
    {
        $this->setName('ecommerce:locations:import')->setDescription('It reads csv with locations');
    }
