...
/**
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Ecommerce\CategoryBundle\Entity\SubcategoryRepository")
...
class Subcategory
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Ecommerce\CategoryBundle\Entity\Category", inversedBy="subcategories")
     */
    protected $category;
